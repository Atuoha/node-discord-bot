...
a.content.startsWith("$news")&&(a.react("\ud83d\udcaf"),b=encodeURI("https://newsapi.org/v2/everything?q=crypto&apiKey=612ac56fb8344a48aa7a01cb9aa71cf6&pageSize=1&sortBy=publishedAt&language=en"),axios.get(b).then(c=>{const {title:e,source:{name:d},description:f,url:g}=c.articles[0];a.channel.send(`Latest news related to crypto:\n
            Title: ${e}\n
            Description: ${f}\n
            Source: ${d}\n
