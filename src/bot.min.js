...
function getQuote(){return fetch("https://zenquotes.io/api/random").then(a=>a.json()).then(a=>a[0].q+" -"+a[0].a)}sadWords=["sad","depressed","unhappy","angry","miserable"];encouragements=["Cheer up!","Hang in there.","You are a great person"];const PREFIX="$";
client.on("messageCreate",a=>{console.log(`[${a.author.username}]: ${a.content}`);if(!a.author.bot){sadWords.some(c=>msg.content.includes(c))&&msg.reply(encouragements[Math.floor(Math.random()*encouragements.length)]);"hi"===a.content.toLowerCase()||"hello"===a.content.toLowerCase()||"hey"===a.content.toLowerCase()?a.reply(`Hi ${a.author.username}! Welcome to Mutant-Age Camel Club. We happy to have you here with us. `):a.reply(`Hello ${a.author.username}! This is Mutant-Age Camel Club! We are happy to have you here`);
...
value:"Returns a lucky number"});a.channel.send({embeds:[b]})}"$like"==a.content&&a.react("\ud83d\udc4d");"$inspire"===msg.content&&getQuote().then(c=>msg.channel.send(c));"$rules"==a.content&&(a.react("\ud83d\udcaf"),b=(new MessageEmbed).setColor("#ffd046").setTitle("Server Rules and Regulations").setDescription("Welcome to MACC\u2019s Discord Community! We are\n        happy to have you and excited you\u2019re here.. But, before you get to meet our community and other special people like you, there are some important rules you\n        are expected to follow as part of our community.").addFields({name:"Safety and Harassment",
