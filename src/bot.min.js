...
a.content.startsWith("$news")&&(b=encodeURI(`https://newsapi.org/v2/everything?q=crypto&apiKey=${process.env.NEWS}&pageSize=1&sortBy=publishedAt&language=en`),axios.get(b).then(c=>{const {title:e,source:{name:d},description:f,url:g}=c.data.articles[0];a.react("\ud83d\udcaf");a.channel.send(`Latest news related to crypto:\n
            Title: ${e}\n
            Description: ${f}\n
            Source: ${d}\n
